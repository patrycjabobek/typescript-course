...
const Pati = new Guitarist("Pati", "flute");
console.log(Pati.play("plays"));
...
const MyBands = new Bands()
MyBands.data = ["Miley Cyrus", "Logic"]
console.log(MyBands.data)
MyBands.data = [...MyBands.data, 'Eminem']
console.log(MyBands.data)
MyBands.data = ['Van Halen', 43312]